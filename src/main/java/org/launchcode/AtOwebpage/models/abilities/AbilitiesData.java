...
import org.launchcode.AtOwebpage.models.NameSorter;
...
public class AbilitiesData {
        ...
        private static ArrayList<AbilityDescription> allAbilityDescriptions = new ArrayList<>();
        private static ArrayList<ClassOfAbility> allClassOfAbilities = new ArrayList<>();
        ...
        public static ArrayList<Ability> findAll() {
            ...
            return new ArrayList<>(allAbilities);
        }
         ...
         */
        public static ArrayList<Ability> findByColumnAndValue(String column, String value) {
            ...
            if (column.equals("all")){
                abilities = findByValue(value);
                return abilities;
            }
            for (Ability ability : allAbilities) {

                String aValue = getFieldValue(ability, column);
        ...
        public static String getFieldValue(Ability ability, String fieldName){
            String theValue = null;

            if (fieldName.equals("name")){
                theValue = ability.getName();
            } else if (fieldName.equals("energyCost")){
                theValue = String.valueOf(ability.getEnergyCost());
            } else if (fieldName.equals("abilityDescription")){
                theValue = ability.getAbilityDescription().toString();
            } else if (fieldName.equals("classOfAbility")) {
                theValue = ability.getClassOfAbility().toString();
            }
         ...
         */
        public static ArrayList<Ability> findByValue(String value) {
            ...
            for (Ability ability : allAbilities) {
                ...
                if (ability.getName().toLowerCase().contains(value.toLowerCase())) {
                    abilities.add(ability);
        ...
        public static ArrayList<AbilityDescription> getAllAbilityDescriptions() {
            loadData();
            allAbilityDescriptions.sort(new NameSorter());
            return allAbilityDescriptions;
        }

        public static ArrayList<ClassOfAbility> getAllClassOfAbilities() {
            loadData();
            allClassOfAbilities.sort(new NameSorter());
            return allClassOfAbilities;
        }
}
