...
public abstract class AbilityField {
    private int id;
    ...
    public AbilityField(String value) {
        this();
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AbilityField)) return false;
        AbilityField abilityField = (AbilityField) o;
        return id == abilityField.id;
    }
